...
function step(){
    ...
    go(0, 'c', 'B', 'B', 1, 'c', 'B', 'B', 'R', 'S', 'S', 0);
    go(1, '1', 'B', 'B', 2, '1', 'B', 'B', 'S', 'L', 'S', 0);
    go(2, '1', '1', 'B', 2, '1', '1', 'B', 'S', 'L', 'S', 0);
    go(2, '1', 'B', 'B', 3, '1', 'B', 'B', 'S', 'R', 'S', 0);
    go(3, '1', '1', 'B', 3, '1', '1', '1', 'S', 'R', 'R', 0);
    go(3, '1', 'B', 'B', 1, '1', 'B', 'B', 'R', 'S', 'S', 0);
    go(1, 'B', 'B', 'B', 6, 'B', 'B', 'B', 'S', 'S', 'S', 0);

    //positif x negatif
    go(1, '0', 'B', 'B', 4, '0', 'B', 'B', 'S', 'L', 'S', 0);
    go(4, '0', '1', 'B', 4, '0', '1', 'B', 'S', 'L', 'S', 0);
    go(4, '0', 'B', 'B', 5, '0', 'B', 'B', 'S', 'R', 'S', 0);
    go(5, '0', '1', 'B', 5, '0', '1', '0', 'S', 'R', 'R', 0);
    go(5, '0', 'B', 'B', 1, '0', 'B', 'B', 'R', 'S', 'S', 0);

    //negatif x positif
    go(0, '0', 'B', 'B', 0, '0', '0', 'B', 'R', 'R', 'S', 0);
    go(2, '1', '0', 'B', 2, '1', '0', 'B', 'S', 'L', 'S', 0);
    go(3, '1', '0', 'B', 3, '1', '0', '0', 'S', 'R', 'R', 0);
   
    //negatif x negatif
    go(4, '0', '0', 'B', 4, '0', '0', 'B', 'S', 'L', 'S', 0);
    go(5, '0', '0', 'B', 5, '0', '0', '1', 'S', 'R', 'R', 0);
